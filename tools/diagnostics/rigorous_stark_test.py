...
class StarkRigorousTester:
    ...
    def _setup_mocks(self):
        ...
        try:
            ...
            class MockVoice:
                ...
                def speak(self, text, mode="online", wait=False):
                    pass  # Corrigido: adicionado wait=False
    ...
    def test_context_engine(self):
        ...
        test_cases = [
            (
                "Jarvis, por favor estude profundamente o código da API em Python",
                "AUTONOMIA",
            ),
            ("Ajuste o brilho para 100% e ligue a GPU no máximo", "HARDWARE"),
            (
                "Estou me sentindo um pouco ansioso com a namorada no relacionamento",
                "PSICOLOGIA",
            ),
        ...
        for cmd, expected in test_cases:
            ...
            if res["contexto"] == expected:
                ...
                self.errors.append(
                    f"FALHA CONTEXTO: '{cmd}' -> {res['contexto']} (Esperado: {expected})"
                )
    ...
    def test_neural_dreaming_concurrency(self):
        ...
        try:
            ...
            if not neural_dreaming.is_dreaming:
                return False
    ...
    def test_agent_flood(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=5) as executor:
            ...
            futures = [
                executor.submit(ai_agent.process_command, f"Comando Flood {i}")
                for i in range(5)
            ]
    ...
    def run_all(self):
        ...
        for t in tests:
            if t():
                ...
                print(f"  ❌ TESTE FALHOU: {t.__name__}")
