...
def smoke_test():
    ...
    try:
        ...
        print(
            f"✅ Hardware Manager: {hardware_manager.device} / {hardware_manager.gpu_name}"
        )
    ...
    # 5. AI Agent
    try:
        print("✅ AI Agent: Pronto (Instância Global)")
    ...
    try:
        ...
        orchestrator = StarkOrchestrator(
            None
        )  # Passando None para Jarvis core por enquanto
