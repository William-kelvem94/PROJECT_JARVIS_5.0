...
class ProjectValidator:
            ...
            for file in src_files:
                try:
                    ...
                    if pattern in content:
                        print_warning(
                            f"{file.relative_to(PROJECT_ROOT)}: Import antigo '{pattern}' - {suggestion}"
                        )
    ...
    def validate_config(self) -> bool:
        ...
        try:
            ...
            required_sections = ["ollama_models", "cloud_models", "brain_router"]
    ...
    def generate_report(self):
        ...
        if not self.errors:
            print(
                f"{Colors.GREEN}{Colors.BOLD}✅ PROJETO VALIDADO COM SUCESSO!{Colors.END}"
            )
