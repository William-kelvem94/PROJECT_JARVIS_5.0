...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("singularity_setup.log"), logging.StreamHandler()],
)
...
class SingularityAutoInstaller:
    ...
    def _check_python(self) -> bool:
        ...
        if self.python_version >= (3, 12):
            logger.warning(
                f"⚠️  Python {self.python_version.major}.{self.python_version.minor} - Some packages may have issues"
            )
    ...
    def _detect_gpu(self):
        ...
        try:
            ...
            logger.info(
                "ℹ️  PyTorch not yet installed - Will detect after installation"
            )
    ...
    def _install_dependencies(self) -> bool:
        ...
        try:
            ...
            if result.returncode != 0:
                ...
                logger.warning(
                    "⚠️  Attempting to continue with partial installation..."
                )
...
""")
        ...
        logger.info("✅ FaceID setup instructions created")
    ...
    def _validate_installation(self) -> bool:
        ...
        for module_name, package_name in optional_imports:
            try:
                ...
                logger.warning(
                    f"⚠️  {package_name} - Optional (some features disabled)"
                )
