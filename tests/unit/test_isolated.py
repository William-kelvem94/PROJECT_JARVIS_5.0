...
def test_isolated_improvements():
    ...
    try:
        ...
        try:
            ...
            if hasattr(src.core.security, '__all__'):
                print(f"   ✅ src.core.security.__all__ = {getattr(src.core.security, '__all__', [])}")
        except ImportError:
        ...
        try:
            ...
            if hasattr(src.core.iot, '__all__'):
                print(f"   ✅ src.core.iot.__all__ = {getattr(src.core.iot, '__all__', [])}")
        except ImportError:
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location(
            "orchestrator", 
            current_dir / "src/core/orchestrator.py"
        )
        ...
        new_methods = ['get_system_info', 'restart_component', '_init_security', '_init_iot']
