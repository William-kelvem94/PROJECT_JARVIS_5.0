...
async def test_event_bus_connections():
    ...
    try:
        ...
        try:
            ...
            from src.core.intelligence.memory.unified_manager import (
            ...
            if memory_manager:
                print(
                    f"Has connect_event_bus: {hasattr(memory_manager, 'connect_event_bus')}"
                )
        ...
        try:
            ...
            if proactive_monitor:
                print(
                    f"Has connect_event_bus: {hasattr(proactive_monitor, 'connect_event_bus')}"
                )
                if hasattr(proactive_monitor, "connect_event_bus"):
                    ...
                    if (
                        hasattr(proactive_monitor, "event_bus")
                        and proactive_monitor.event_bus
                    ):
                        try:
                            proactive_monitor.event_bus.loop = (
                            ...
                            print(
                                f"proactive_monitor.event_bus type: {type(proactive_monitor.event_bus)}"
                            )
                            print(
                                f"proactive_monitor.event_bus value: {repr(proactive_monitor.event_bus)}"
                            )
                            traceback.print_exc()
                    else:
