...
def test_advanced_action_controller():
    ...
    try:
        ...
        print(f"✅ Teste 2.2: CPU {info['cpu_percent']}%, RAM {info['memory_percent']}%")
...
def test_workflow_engine():
    ...
    try:
        ...
        workflow_engine.add_step("test_workflow", WorkflowStep(
            type="wait",
            params={"duration": 0.1},
...
def test_advanced_vision_pipeline():
    ...
    try:
        ...
        print(f"✅ Teste 4.2: Nível 2 (EasyOCR): {advanced_vision_pipeline.level2_available}")
        print(f"✅ Teste 4.3: Nível 3 (Gemini): {advanced_vision_pipeline.level3_available}")
...
def test_advanced_speech_processor():
    ...
    try:
        ...
        print(f"✅ Teste 5.2: TTS disponível: {advanced_speech_processor.tts_available}")
