...
def test_sanitization():
    ...
    test_cases = [
        (
            "O arquivo está em C:\\Users\\Admin\\Documents\\test.txt",
            "O arquivo está em o local do sistema",
        ),
        (
            "Acesse /home/user/project/main.py agora",
            "Acesse o caminho do arquivo agora",
        ),
        (
            "Erro no diretório D:\\Games\\Skyrim\\data",
            "Erro no diretório o local do sistema",
        ),
