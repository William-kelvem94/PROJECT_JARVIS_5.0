...
def test_1_structured_models():
    ...
    try:
        ...
        response = AgentResponse(
            ...
            actions=[type_text, PressKeyAction(key="enter")],
...
def test_2_response_parser():
    ...
    try:
        ...
        legacy_response = (
            "Vou fazer isso [ACTION: type_text('teste')] [ACTION: press_key('enter')]"
        )
    ...
    try:
        ...
        llm_response = json.dumps(
            {
                ...
                "actions": [
                    ...
                    {"action": "read_file", "path": "data/temp/test_p1.txt"},
                ],
        ...
        if test_file.exists():
            ...
            if "Teste P1" in content:
                print("✅ Fase 3 - Arquivo criado com sucesso")
