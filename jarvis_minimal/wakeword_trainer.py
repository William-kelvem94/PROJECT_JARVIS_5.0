...
Usage:
  python -m jarvis_minimal.wakeword_trainer --data-dir jarvis_minimal/wake_data --epochs 10

Data layout expected:
  jarvis_minimal/wake_data/pos/  <-- wav samples containing the wakeword
  jarvis_minimal/wake_data/neg/  <-- negative samples (speech / noise without wakeword)

Outputs:
  - Trained scripted model saved to `jarvis_minimal/models/wakeword.pth`
