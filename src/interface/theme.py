...
class JarvisTheme:
    ...
    # Cores Base
    PRIMARY_CYAN = QColor(0, 195, 255)  # Neon Stark Principal
    SECONDARY_PURPLE = QColor(112, 0, 255)  # Singularity Accent
    SECONDARY_ORANGE = QColor(255, 140, 0)  # Modo Escuta
    ACCENT_GOLD = QColor(255, 215, 0)  # Destaques
    SUCCESS_GREEN = QColor(0, 255, 127)  # Sucesso Neon
    WARNING_YELLOW = QColor(255, 255, 0)  # Aviso
    ERROR_RED = QColor(255, 49, 49)  # Erro Neon

    # Backgrounds
    BG_DARK = QColor(3, 6, 10)  # Fundo Ultra Dark
    BG_MEDIUM = QColor(11, 15, 25)  # Painéis Stark
    BG_LIGHT = QColor(31, 41, 58)  # Hover states / Destaques
