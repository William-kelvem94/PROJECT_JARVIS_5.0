...
def get_neural_systems(data_dir: Path, config: Optional[Any] = None) -> NeuralSystemsLoader:
...
def init_neural_systems(data_dir: Path, config: Optional[Any] = None) -> NeuralSystemsLoader:
