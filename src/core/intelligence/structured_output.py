...
class CreateDirAction(BaseModel):
    ...
    action: Literal[ActionType.CREATE_DIR] = ActionType.CREATE_DIR
    path: str = Field(..., min_length=1, description="Caminho do diretório a criar")
...
class SearchLocalFilesAction(BaseModel):
    """Ação: Buscar arquivos no computador usando MetaCache"""
...
class RunAutonomousResearchAction(BaseModel):
    """Ação: Pesquisa profunda na web sobre um tema"""
...
class DeleteFileAction(BaseModel):
    """Ação: Excluir um arquivo (Requer permissão da Jaula de Vidro)"""
    ...
    return {
        ...
        "properties": {
            ...
            "actions": {
                ...
                "items": {
                    "oneOf": [
                        ClickAction.model_json_schema(),
                        TypeTextAction.model_json_schema(),
                        PressKeyAction.model_json_schema(),
                        HotkeyAction.model_json_schema(),
                        ScrollAction.model_json_schema(),
                        OpenProgramAction.model_json_schema(),
                        ReadFileAction.model_json_schema(),
                        WriteFileAction.model_json_schema(),
                        ListDirAction.model_json_schema(),
                        CreateDirAction.model_json_schema(),
                        SearchWebAction.model_json_schema(),
                        OpenUrlAction.model_json_schema(),
                        WaitAction.model_json_schema(),
                        OrganizeDirectoryAction.model_json_schema(),
                        ReadCodebaseAction.model_json_schema(),
                        ReadCodeFileAction.model_json_schema(),
                        UpdateSystemCodeAction.model_json_schema(),
                        ReadClipboardAction.model_json_schema(),
                        AnalyzeAndOrganizeAction.model_json_schema(),
                        GetProcessesAction.model_json_schema(),
                        SetProcessPriorityAction.model_json_schema(),
                        SetPowerPlanAction.model_json_schema(),
                        GetHardwareSuggestionsAction.model_json_schema(),
                        RegisterNicknameAction.model_json_schema(),
                        SearchLocalFilesAction.model_json_schema(),
                        RunAutonomousResearchAction.model_json_schema(),
                    ]
                }
            },
            "final_answer": {
