...
class KnowledgeDistiller:
    ...
    def distill_interaction(self, user_command: str, thought: str, actions: List[Dict[str, Any]], success: bool = True):
        ...
        interaction_data = {
            ...
            "usage_count": self.gold_commands.get(cmd_key, {}).get("usage_count", 0) + 1
        }
    ...
    def get_relevant_examples(self, current_command: str, limit: int = 2) -> str:
        ...
        matches = difflib.get_close_matches(current_command.lower(), self.gold_commands.keys(), n=limit, cutoff=0.6)
