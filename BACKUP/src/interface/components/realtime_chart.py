...
class RealtimeChart(QWidget):
    ...
    def __init__(self, title, max_points=60, parent=None):
        ...
        self.setStyleSheet(
            "background-color: #0b0f19; border: 1px solid #1f293a; border-radius: 5px;"
        )
    ...
    def paintEvent(self, event):
        ...
        poly_points = (
            [QPointF(margin_left, margin_top + plot_height)]
            + points
            + [QPointF(width - margin_right, margin_top + plot_height)]
        )
