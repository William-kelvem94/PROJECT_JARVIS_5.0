...
class EmotionVoiceCNN(nn.Module):
    ...
    def __init__(self, num_emotions=7):
        ...
        self.conv1 = nn.Conv1d(
            in_channels=40, out_channels=64, kernel_size=5, padding=2
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default="data/training_dataset/emotions",
        help="Path to emotion dataset",
    )
    parser.add_argument(
        "--output",
        type=str,
        default="models/emotion_voice.pth",
    ...
    parser.add_argument(
        "--test-audio", type=str, default=None, help="Test audio file after training"
    )
