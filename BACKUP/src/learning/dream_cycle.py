...
from src.learning.self_audit import SelfAuditor
...
class DreamCycle:
    ...
    def __init__(self, data_dir: Path, config: Optional[DreamCycleConfig] = None):
        ...
        self.auditor = SelfAuditor(self.data_dir.parent) # Root is parent of data/
    ...
    def _start_dream_sequence(self):
        ...
        try:
            ...
            # 3. Executar Auto-Auditoria
            logger.info("🕵️ Executando Auto-Auditoria...")
