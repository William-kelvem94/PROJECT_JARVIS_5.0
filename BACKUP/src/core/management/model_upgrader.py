...
class ModelUpgrader:
    ...
    def install_xtts_v2(self) -> bool:
        ...
        try:
            ...
            result = subprocess.run(
                ["pip", "install", "TTS"], capture_output=True, text=True, timeout=300
            )
    ...
    def get_recommendations(self) -> List[str]:
        ...
        if not self.available_models["qwen"]["3B"]["installed"]:
            recommendations.append("ðŸ§  Upgrade Qwen para 3B para melhor performance")
        ...
        if not self.available_models["xtts"]["v2"]["installed"]:
            recommendations.append("ðŸ—£ï¸ Instale XTTS-v2 para TTS de alta qualidade")
